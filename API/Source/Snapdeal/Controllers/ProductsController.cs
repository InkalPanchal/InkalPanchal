...
namespace Snapdeal.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        private IAttributeService attrservice { get; set; }
        public ProductsController(IProductService productService, IAttributeService attrService)
        {
        ...
        {
            var obj = await ProductService.GetByProdId(id);
        ...
        {
            return Ok(await ProductService.GetProductImages());
        }
        ...
        {
            return Ok(await ProductService.GetProductDetail());
        }

        [AllowAnonymous]
        [HttpPost("searchProduct")]
        public async Task<IActionResult> SearchProduct([FromBody] Product product)
        {
            return Ok(await ProductService.SearchProduct(product));
        }
